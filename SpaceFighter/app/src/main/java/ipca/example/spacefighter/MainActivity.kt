                ...
                Scaffold(modifier = Modifier.fillMaxSize()) { _ ->
                    NavHost(navController = navController, startDestination = "game_start") {
                        ...
                        composable("game_over") {
                            GameOverView(onPlayAgainClick = {
                                // Reinicia o jogo, removendo a tela atual
                                navController.popBackStack("game_screen", false) // Remove a tela de game_over
                                navController.navigate("game_screen") // Vai para game_screen novamente
                            })
                        }
                    }
                }
