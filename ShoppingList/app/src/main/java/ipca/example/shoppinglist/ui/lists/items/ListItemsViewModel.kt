...
class ListItemsViewModel : ViewModel(){
    ...
    fun updateItemChecked(listId: String, item: Item, isChecked: Boolean) {
        ItemRepository.setChecked(listId, item, isChecked)
        getItems(listId) // Atualiza os itens na lista
    }
